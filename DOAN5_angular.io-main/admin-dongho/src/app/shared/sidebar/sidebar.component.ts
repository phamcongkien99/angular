...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  {name:'Quản lý đòng hồ',url:'',icon:'signal',childs:[{name:'Quản lý đơn hàng',url:'/product/order'},{name:'Quản lý loại đồng hồ',url:'/product/type'},{name:'Quản lý đồng hồ',url:'/product/product'}]}];
  constructor() { }
  ngOnInit(): void {
  }
  ngAfterViewInit() {
